...
from Lesson_8.instaparser.spiders.instagram_spider import InstagramSpiderSpider
...
def set_parse_users() -> list:
    ...
    while 1:
        users.append(input(f'Введите не менее 2х аккаунтов пользователей Instagram для сбора данных.\n'
                           ...
                           f'Для завершения ввода - ввести пустую строку (сразу жать enter): '))
...
if __name__ == '__main__':
    ...
    parse_users = ['valerieel', 'igordavydov']  # set_parse_users()
