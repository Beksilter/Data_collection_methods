...
class InstagramSpiderSpider(scrapy.Spider):
    ...
    insta_login = passwords_login.user_login
    insta_pwd = passwords_login.insta_pwd
    inst_login_link = 'https://www.instagram.com/accounts/login/'
    graphql_url = 'https://www.instagram.com/graphql/query/?'
    posts_hash = passwords_login.posts_hash
    followers_hash = passwords_login.followers_hash
    following_hash = passwords_login.following_hash
    followers, following = {}, {}
