...
user_login = passwords_login.user_login
user_password = passwords_login.user_password
base_url = 'https://mail.ru/'

client = MongoClient('localhost', 27017)

db = client['mail']
msgs_collection = db['msg']
...
button_login = driver.find_element(By.XPATH,
                                   "//button[@class='resplash-btn resplash-btn_primary resplash-btn_mailbox-big svelte-1y37831']")
